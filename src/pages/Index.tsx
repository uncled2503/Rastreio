...
import { 
  Search, Truck, Bell, History, ShieldCheck, HelpCircle, ArrowRight, PackageCheck, Zap, Check, X, Phone
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-white text-zinc-900 font-sans scroll-smooth">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <form onSubmit={handleSearch} className="max-w-3xl mx-auto mb-20 relative">
            <div className="flex flex-col md:flex-row gap-3 p-3 bg-white border-2 border-zinc-100 rounded-3xl shadow-2xl relative z-10">
              ...
              <Button type="submit" disabled={isSearching} className="bg-green-600 hover:bg-green-700 text-white h-14 md:h-16 px-10 text-lg font-black rounded-2xl">RASTREAR AGORA</Button>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 bg-white rounded-[2rem] border border-zinc-100 shadow-sm hover:shadow-md transition-shadow">
      ...
      <section className="py-24 overflow-hidden">
        <div className="container mx-auto px-4 max-w-6xl flex flex-col md:flex-row items-center gap-20">
          ...
          <div className="flex-1 relative">
            <div className="relative z-10 w-[280px] md:w-[320px] mx-auto bg-zinc-900 p-3 rounded-[3rem] shadow-2xl border-4 border-zinc-800">
               <div className="bg-white rounded-[2.5rem] p-6 h-[500px] flex flex-col items-center justify-center text-center">
                  ...
                  <div className="space-y-4 w-full">
                    {[1,2,3].map(i => <div key={i} className="h-2 bg-zinc-100 rounded-full w-full" style={{ opacity: 1 - i * 0.2 }} />)}
                  </div>
               </div>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <div key={i} className={`p-10 rounded-[2.5rem] bg-white border-2 relative ${p.popular ? 'border-green-500 shadow-xl shadow-green-500/10' : 'border-zinc-100 shadow-sm'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div key={i} className="p-8 bg-white rounded-[2rem] border-2 border-zinc-100 flex flex-col md:flex-row items-center justify-between gap-8">
      ...
      <section className="py-24 px-4 bg-[#111] text-white">
        ...
        <div className="container mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-4 gap-6">
          {faqs.map((f, i) => (
            <div key={i} className="p-8 bg-zinc-900 rounded-[2rem] border border-zinc-800 text-left group hover:border-zinc-700 transition-colors cursor-pointer" onClick={() => setSelectedFaq(f)}>
      ...
      <section className="py-32 px-4 bg-white">
        <div className="container mx-auto max-w-5xl bg-green-600 rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl shadow-green-600/30">
          <div className="relative z-10">
            ...
            <Button className="bg-white text-green-600 hover:bg-zinc-50 h-16 md:h-20 px-12 text-xl font-black rounded-2xl shadow-xl">CRIAR MINHA CONTA GRÁTIS</Button>
